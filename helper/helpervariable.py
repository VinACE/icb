...
class HelperVariable(object):
    ...
    def __init__(self):
        ...
        self.CONTAGIOUS_SITE_URL = str(self.config_manager.config_item('CONTAGIOUS_SITE', 'CONTAGIOUS_SITE_URL'))
        self.CONTAGIOUS_SCRAPE_CHOICES = str.split(self.config_manager.config_item('CONTAGIOUS_SITE', 'CONTAGIOUS_SCRAPE_CHOICES'), ',')
        ##############################################################################################
'''
